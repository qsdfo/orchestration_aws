...
#         pass
    ...
    def jazzChordToXml(self, jc):
        '''
        Converts a JazzChord object to mxHarmony object
        '''
        mxHarmony = jc.to_xml()
        _synchronizeIds(mxHarmony, jc)
        self.setPrintObject(mxHarmony, jc)
        self.setPrintStyle(mxHarmony, jc)
        self.setOffsetOptional(jc, mxHarmony)
